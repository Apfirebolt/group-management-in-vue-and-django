<template>
  <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="my-2">
      <button @click="changeLanguage('en')" class="px-2 py-1 text-sm hover:bg-green-600 bg-green-300 shadow-md mr-1">English</button>
      <button @click="changeLanguage('de')" class="px-2 py-1 text-sm hover:bg-green-600 bg-green-300 shadow-md">Deutsch</button>
    </div>
